...
version = metakernel.__version__
# The full version, including alpha/beta/rc tags.
release = metakernel.__version__
...
htmlhelp_basename = 'Metakerneldoc'
...
latex_documents = [
  ('index', 'Metakernel.tex', u'Metakernel Documentation',
   u'Metakernel contributors', 'manual'),
]
